...
const axios = require('axios'); 
  ...
  export const fetchDistribution = createAsyncThunk('fetchDistribution', async () => {
    const response = await axios.get('http://localhost:8000/api/distribution_header');
  ...
  export const addDistribution = createAsyncThunk('addDistribution', async (data) => 
  {
      ...
      const response = await axios.post('http://localhost:8000/api/distribution_header', formData, {
                      headers: {
  ...
  export const addDistributionLine = createAsyncThunk('addDistributionLine', async (data) => 
  {
      ...
      const response = await axios.post('http://localhost:8000/api/distribution_lines', formData, {
                      headers: {
                          'Content-Type': 'multipart/form-data',
                      },
                  });
  ...
  export const fetchDistributionId = createAsyncThunk('fetchDistributionId',async (id)=>{
    const response = await axios.get('http://localhost:8000/api/distribution_header/'+id);
    return response.data;
  });


  export const fetchDistributionListId = createAsyncThunk('fetchDistributionListId',async (id)=>{
    const response = await axios.get('http://localhost:8000/api/distribution_lines/'+id);
    return response.data;
  });
  ...
  export const EditPlan = createAsyncThunk('EditPlan',async (data)=>{
    ...
    const response = await axios.post('http://localhost:8000/api/distribution_lines/'+data.distributionId,formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data',
                    },
                });
  ...
  export const deleteDistributionHeader = createAsyncThunk('deleteDistributionHeader',async (id)=>{
    const response = await axios.delete('http://localhost:8000/api/distribution_header/'+id);
    return response.data;
  });
  ...
  export const fetchVehicle = createAsyncThunk('fetchVehicle', async () => {
    const response = await axios.get('http://localhost:8000/api/vehiclefleet');
  ...
  export const fetchTruckCategory = createAsyncThunk('fetchTruckCategory', async () => {
    const response = await axios.get('http://localhost:8000/api/truckcategory');
    return response.data;
  });
  ...
  export const fetchStatusDistribution = createAsyncThunk('fetchStatusDistribution', async () => {
    const response = await axios.get('http://localhost:8000/api/statusdistribution');
    return response.data;
  });
...
//     const response = await axios.get('http://localhost:8000/api/role/'+id);
//     return response.data;
//   });
  ...
  export const addPlan = createAsyncThunk('addPlan',async (data)=>{
    ...
    const response = await axios.post('http://localhost:8000/api/distribution_header/'+data.distributionId,formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data',
                    },
                });
  ...
  export const addMap = createAsyncThunk('addMap', async (data) => 
  {
      ...
      const response = await axios.post('http://localhost:8000/api/mapping', formData, {
                      headers: {
                          'Content-Type': 'multipart/form-data',
                      },
                  });
